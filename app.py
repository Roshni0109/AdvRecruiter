...
with gr.Blocks() as demo:
    ...
    with gr.Tab("Mode 1: Rank Existing Pool"):
        ...
        with gr.Row():
            with gr.Column(scale=1):
                jd_input_1 = gr.Textbox(value=JD_TEXT, label="Job Description", lines=15)
    ...
    with gr.Tab("Mode 2: Upload & Rank New Resumes"):
        ...
        with gr.Row():
            with gr.Column(scale=1):
                file_input = gr.File(label="Upload Candidate JSON/JSONL")
                jd_input_2 = gr.Textbox(value=JD_TEXT, label="Job Description", lines=10)
